...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/Pocket/Body_Pocket/Object" priority="10">
		<xsl:if test="@Name = 'QUOTATION'">
			<xsl:if test="(contains(Property[@Name='Instrument'], '=AG')) or (contains(Property[@Name='Instrument'], '=AU')) or (contains(Property[@Name='Instrument'], '=G')) or (contains(Property[@Name='Instrument'], '=L')) or (contains(Property[@Name='Instrument'], '=LMP')) or (contains(Property[@Name='Instrument'], '=M')) or (contains(Property[@Name='Instrument'], '=MM')) or (contains(Property[@Name='Instrument'], '=P')) or (contains(Property[@Name='Instrument'], '=PF')) or (contains(Property[@Name='Instrument'], '=SG')) or (contains(Property[@Name='Instrument'], '=TUAMCT')) or (contains(Property[@Name='Instrument'], '=TUSWCT'))">
				<Object Name="QUOTATION">
					...
					<Property Name="LAST_PRICE">
						<xsl:value-of select="Property[@Name='Last Price']"/>
					</Property>
