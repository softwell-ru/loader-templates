...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/Pocket/Body_Pocket/Object" priority="10">
		<xsl:if test="@Name = 'CUSTOMER'">
			...
			<xsl:choose>
                            <xsl:when test="Property[@Name='EMAIL']= 'РѕС?СЃСѓС?СЃС?РІСѓР?С?'">
                                <Property Name ="EMAIL">
                                    <xsl:value-of select="''">
                                    </xsl:value-of>
                                </Property>
                            </xsl:when>
				<xsl:when test="Property[@Name='EMAIL']= 'РЅР?С?'">
                                <Property Name ="EMAIL">
                                    <xsl:value-of select="''">
                                    </xsl:value-of>
                                </Property>
			...
			<xsl:choose>
                            <xsl:when test="Property[@Name='TRADE_STATUS']!= ''">
				<Property Name="TRADE_STATUS">
					<xsl:value-of select="Property[@Name='TRADE_STATUS']">
                                    </xsl:value-of>
				</Property>
			    </xsl:when>
                                <xsl:when test="Property[@Name='TRADE_ACCESS']!= ''">
                                <Property Name ="TRADE_STATUS">3</Property>
				</xsl:when>
                        </xsl:choose>

			<xsl:choose>
                            <xsl:when test="Property[@Name='CLEARING_STATUS']!= ''">
				<Property Name="CLEARING_STATUS">
					<xsl:value-of select="Property[@Name='CLEARING_STATUS']">
                                    </xsl:value-of>
				</Property>
			    </xsl:when>
			    <xsl:when test="Property[@Name='CLEARING_ACCESS']!= ''">
                                	<Property Name ="CLEARING_STATUS">1</Property>
			    </xsl:when>
                        </xsl:choose>
				...
				<Property Name="SEC_ROLES">
					...
					<xsl:value-of select="$TradeAccess + $ClearingAccess + 16"/>
				</Property>
			</Object>
		</xsl:if>
		<xsl:if test="@Name = 'PAYMENTS'">
			<Object Name="vw_T_TRANSACTIONS">
				...
				<Property Name="ACCPOINTER">
                            <xsl:value-of select="Property[@Name='CODE_OTC_CLIENT']">
                            </xsl:value-of>
				</Property>
				<Property Name="NAZN">
		...
		<xsl:if test="@Name = 'REST'">
			<Object Name="ACCBALANCE">
                ...
                <Property Name="CLOSEDAY">False</Property>
				<Property Name="NCLASS">
